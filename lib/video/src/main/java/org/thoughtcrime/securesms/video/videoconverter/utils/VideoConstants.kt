...
object VideoConstants {
  ...
  const val VIDEO_SHORT_EDGE_SD = 720
  const val VIDEO_SHORT_EDGE_HD = 1080
  const val VIDEO_LONG_EDGE_HD = 1920
  ...
  val DEFAULT_LVL1_STANDARD = QualityTier(resolution = VIDEO_SHORT_EDGE_SD, videoBitrateMbps = 3.5f, audioBitrateKbps = 192, maxDurationSec = 900)
  val DEFAULT_LVL2_SHORT_STANDARD = QualityTier(resolution = VIDEO_SHORT_EDGE_HD, videoBitrateMbps = 4.5f, audioBitrateKbps = 192, maxDurationSec = 600)
  val DEFAULT_LVL2_LONG_STANDARD = QualityTier(resolution = VIDEO_SHORT_EDGE_HD, videoBitrateMbps = 4.5f, audioBitrateKbps = 192, maxDurationSec = 900)

  @JvmStatic
  val DEFAULT_HIGH = QualityTier(resolution = VIDEO_SHORT_EDGE_HD, videoBitrateMbps = 6.0f, audioBitrateKbps = 192, maxDurationSec = 360)
